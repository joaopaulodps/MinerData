...
export default function GuestMineralData({ auth }) {
    return (
        <>
            <Head title="Catálogo" />
            <GuestLayout {...{ auth }}>
                    ...
                    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 relative">
                        <div className="bg-transparent flex flex-col items-center justify-center h-full relative">
                            ...
                            <div className="absolute bottom-full mb-8 w-64 text-center bg-white text-gray-900 border border-gray-300 rounded-xl p-6 shadow-lg"
                                ...
                                <p className="text-lg font-semibold">Ops! Parece que ainda não encontrei o mineral que você procura!</p>
                                <NavLink href={route('guest.mineralsIndex')}><p className="text-lg font-semibold" style={{color: '#FF5722'}}>Clique aqui para ver os minerais que já foram encontrados!</p></NavLink>
                            ...
                            {/* Imagem */}
                            <img src="/storage/photos/mineral_not_found.png" alt="Descrição da Imagem" className="max-w-full" style={{ height: '300px' }} />
                        </div>
                    </div>
                </div>
            </GuestLayout>
